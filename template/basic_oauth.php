...
?>
    ...
    <div class="wrap">
        ...
        if( isset( $_GET[ 'delete' ] ) && $_GET[ 'delete' ] =='ba'  ) {
            ...
            $url = admin_url() . '?page=basic_auth&tab=basic_auth';
            header('Location: ' . $url);
            die();
        }
        ...
        <h2 class="nav-tab-wrapper">
            <a href="?page=basic_auth&tab=basic_auth" class="nav-tab <?php echo ( $_GET[ 'tab' ] ==''  ||  $_GET[ 'tab' ] =='basic_auth'  ) ? 'tab-active' :  '';
            ?> <?php
            echo ( $_GET[ 'tab' ] ==''  ) ?
                $_GET[ 'tab' ] :  ''; ?>">Basic
                Auth</a>
            <a href="?page=basic_auth&tab=auth_one" class="nav-tab <?php echo  ( $_GET[ 'tab' ] =='auth_one' ) ? 'tab-active' :  ''; ?>">OAuth One</a>
            <a href="?page=basic_auth&tab=all_products" class="nav-tab <?php echo  ( $_GET[ 'tab' ] =='all_products' ) ? 'tab-active' :  ''; ?>">All Porducts</a>
            <a href="?page=basic_auth&tab=orders" class="nav-tab <?php echo  ( $_GET[ 'tab' ] =='orders' ) ? 'tab-active' :  ''; ?>">Orders</a>
            <a href="?page=basic_auth&tab=cron" class="nav-tab <?php echo  ( $_GET[ 'tab' ] =='cron' ) ? 'tab-active' :  ''; ?>">Cron</a>
        </h2>
        <!-- ===========================================================================================================
     ...
     =============================================================================================================-->
        ...
        <div class="container">
            ...
            if( $active_tab == 'basic_auth' || $active_tab == ''  ):
                ...
                <hr>
                <br/>
                <a class=" hmu-input hmu-delete" href="<?php echo admin_url() ?>?page=basic_auth&tab=basic_auth&delete=ba">Delete table</a>
